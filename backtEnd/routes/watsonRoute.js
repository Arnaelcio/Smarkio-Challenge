...
router.post('/watson', (req,res)=>{
    ...
    const textToSpeech = new TextToSpeechV1({
        authenticator: new IamAuthenticator({ apikey: 'woSY-xz7DmBZ_4MMvyN328o0pmKgG_lq71miaj4PDd7O' }),
        serviceUrl: 'https://api.us-south.text-to-speech.watson.cloud.ibm.com',
        headers: {
          'Access-Control-Allow-Origin': 'https://api.us-south.text-to-speech.watson.cloud.ibm.com',
